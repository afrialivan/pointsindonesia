...
export default function ContactPage() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      setStatus('success');
      // Redirect langsung ke WhatsApp Points Indonesia
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div>
                <h2 className="font-display font-extrabold text-2xl sm:text-3xl text-[#0B1437] mb-3">
                  Mari Terhubung
                </h2>
              ...
              <div className="space-y-4 pt-4">
                {contactCards.map((card, idx) => (
                  <motion.a
                    ...
                    className="block bg-[#F7F9FC] rounded-2xl p-6 border border-[#E4E7EC] hover:border-[#155EEF]/30 hover:shadow-md transition-all duration-200"
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <span className="block font-display font-bold text-sm text-[#0B1437] mb-0.5">
                          {card.title}
                        </span>
                        <span className="block font-display font-semibold text-base text-[#155EEF] mb-1">
                          {card.detail}
                        </span>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6, ease: 'easeOut' }}
              className="lg:col-span-7 bg-[#F7F9FC] rounded-3xl p-8 sm:p-10 border border-[#E4E7EC] shadow-sm"
            >
              <h3 className="font-display font-bold text-2xl text-[#0B1437] mb-2">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block font-display font-semibold text-xs uppercase tracking-wider text-[#0B1437] mb-2">
                      Nama Lengkap *
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full bg-white border border-[#E4E7EC] rounded-xl px-4 py-3 text-sm text-[#0B1437] placeholder:text-[#98A2B3] focus:outline-none focus:border-[#155EEF] transition-colors"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-white border border-[#E4E7EC] rounded-xl px-4 py-3 text-sm text-[#0B1437] focus:outline-none focus:border-[#155EEF] transition-colors"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white border border-[#E4E7EC] rounded-xl px-4 py-3 text-sm text-[#0B1437] placeholder:text-[#98A2B3] focus:outline-none focus:border-[#155EEF] transition-colors resize-none"
                  />
                </div>
                ...
                <motion.button
                  ...
                  className="w-full font-display font-semibold text-base text-white px-7 py-4 rounded-xl bg-linear-to-r from-[#155EEF] to-[#6941C6] shadow-[0_8px_20px_rgba(21,94,239,0.25)] hover:shadow-[0_12px_28px_rgba(21,94,239,0.35)] transition-all duration-200 inline-flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  {status === 'submitting' ? (
